<script lang="ts">
    ...
    async function g() {
        ...
        // console.log([maxX, maxY, minX, minY].map(normalize(-1000, 1000)))
    }
    onMount(() => {
        g();
    });
